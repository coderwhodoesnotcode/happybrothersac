...
export default function CTASection({
  ...
  return (
    <section className={`relative overflow-hidden ${variants[variant]} py-20`}>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              ...
              size="lg"
              icon={Phone}
              className="bg-white text-brand-purple hover:bg-gray-100 shadow-2xl min-w-[200px]"
            >
              {primaryButtonText}
            </Button>
            <Button
              ...
              size="lg"
              icon={MessageSquare}
              className="border-white text-white hover:bg-white hover:text-brand-purple min-w-[200px]"
            >
              {secondaryButtonText}
            </Button>
          </div>
      ...
      {/* Bottom Wave (optional decoration) */}
